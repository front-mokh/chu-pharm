      ...
      <Card className="h-full flex flex-col shadow-lg">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">
            Commandes de médicaments livrées ({orders.length})
          </CardTitle>
          <CardDescription>
            Liste des commandes de médicaments qui ont été livrées aux services.       
          </CardDescription>
        </CardHeader>
        <CardContent className="flex-grow p-0 md:p-6">
          <DeliveredOrdersTable orders={pageItems} />
        </CardContent>
        {totalPages > 0 && (
