...
import PreparedOrdersTable from "./PreparedOrdersTable";
      ...
      <Card className="h-full flex flex-col shadow-lg">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">
            Commandes de médicaments préparées pour les services ({orders.length})
          </CardTitle>
          <CardDescription>
            Liste des commandes de médicaments qui ont été préparées et sont prêtes pour les services.          
          </CardDescription>
        </CardHeader>
        <CardContent className="flex-grow p-0 md:p-6">
          <PreparedOrdersTable orders={pageItems} />
        </CardContent>
        {totalPages > 0 && (
